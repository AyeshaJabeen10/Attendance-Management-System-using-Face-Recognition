    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='shivasu1@#', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def enter_data_DB():
                ...
                if ENROLLMENT == '':
                    ...
                    Insert_data = "INSERT INTO " + manually_fill_attendance + \
            ...
            def create_csv():
                import csv
                cursor.execute("select * from " + manually_fill_attendance + ";")
                csv_name = r'C:\Users\ghous\Downloads\attendence management system\attendence management system\Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,C:\Users\ghous\Downloads\attendence management system\attendence management system\Attendance"\-------Check atttendance-------"')
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='shivasu1@#', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                insert_data = "INSERT INTO " + Face_reco_fill + \
                    " (ID,ENROLLMENT,NAME,DATE,TIME) VALUES (0, %s, %s, %s,%s)"
                ...
                root.configure(background='grey80')
                cs = r'C:\Users\ghous\Downloads\attendence management system\attendence management system\Attendance' + DB_table_name + '.csv'
    ...
    def log_in():
        ...
        if username == 'shiva':
            if password == 'shiva123':
                ...
                cs =r'C:\Users\ghous\Downloads\attendence management system\attendence management system\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
